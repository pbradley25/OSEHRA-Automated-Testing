...
class WebDriver(object):
    ...
    def execute(self, driver_command, params=None):
        ...
        # Print command and command parameters   
        paramArray = []
        
        for key, value in params.iteritems():
            paramArray.append(str(key) +  " = " + str(value))            
            
        logging.info("selenium.webdriver.remote.webdriver.execute() - "  + driver_command + "\n" + "Executing: " + str(paramArray))
        
        response = self.command_executor.execute(driver_command, params)
        # Print response after command executed
        responseArray = []
        
        for key, value in response.iteritems(): 
            responseArray.append(str(key) +  " = " + str(value))           
            
        logging.debug("selenium.webdriver.remote.webdriver.execute() - "  + driver_command + "\n" + "Response: " + str(responseArray))
